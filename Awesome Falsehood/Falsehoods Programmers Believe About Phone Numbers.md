...
Creado: 2022-06-21 17:08
Tags: #every-programmer-should-know, #falsehoods, #phone-numbers
...
2. **You can make a call to any phone number**
...
5.  **Phone numbers cannot be re-used**

> Old phone numbers are recycled and get reassigned to other people.

6.  **Phone numbers that are valid today will always be valid. Phone numbers of
...
7.  **Each country calling code corresponds to exactly one country**
...
8.  **Each country has only one country calling code**
...
9.  **A phone number is dialable from anywhere**
...
10.  **You can send a text message to any phone number**
...
11.  **Only mobile phones can receive text messages**
...
12.  **There are only two ways to dial a phone number: domestically and from
    overseas**
...
13.  **To make a number dialable, you only need to change the prefix**
...
14.  **No prefix of a valid phone number can be a valid phone number**
...
15.  **An invalid number will not reach an endpoint**
...
17.  **All valid phone numbers belong to a country**
...
19.  **Phone numbers are always written in ASCII**

> In Egypt, it is common for phone numbers to be written in native digits.

20.  **Phone numbers have only one prefix (area code or national destination
...
21.  **A leading zero in numbers formatted for domestic usage can always be
...
22.  **The country or area code of a phone number indicates the user's location,
...
23.  **The plus sign in front of phone numbers in international format is
    optional, or can always be replaced by `00`**

>  The plus sign is part of the [E.164 format](https://en.wikipedia.org/wiki/E.164) for international telephone
    numbers. It can be replaced with the [international call prefix](https://en.wikipedia.org/wiki/List_of_international_call_prefixes) when dialing internationally. Note that while `00` is a common international call prefix, this actually varies by country.
...
26.  **Phone numbering plans published by governments or telecoms represent
    reality**
