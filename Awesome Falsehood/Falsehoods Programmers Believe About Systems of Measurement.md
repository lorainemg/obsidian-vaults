...
Creado: 2022-06-21 17:47
Tags: #every-programmer-should-know, #falsehoods, #science, #measures
...
- Fractional dimensions are of no practical use. (Radar beam height formula uses a constant expressed in [nautical miles per foot^(1/2)](http://www.boost.org/doc/libs/1_37_0/doc/html/boost_units/Units.html))
